	...
	public void createConfFile()
	{
		...
		try {
			...
			defText = new StringBuilder()
						...
						.append("#      log-file: Specify log file used in daemon mode. If it is not specified,\n")
						...
						.append("}\n\n")
						.append("ddt-root-node {\n")
						.append("        address     = 2001:40B0:1::F0F2\n")
						.append("        priority    = 1\n")
						.append("        weight      = 100\n")
						.append("}\n\n")
						.append("# Current LISP beta-network (lisp4.net/lisp6.net) DDT root nodes:\n")
						.append("# IPv4: \n")
						.append("#      - csuc-ddt.rloc.lisp4.net: 84.88.16.10\n")
						...
						.append("# IPv6: \n")
						.append("#      - csuc-ddt.rloc.lisp6.net: 2001:40B0:1::F0F2\n")
						.append("#      - arin-ddt.rloc.lisp6.net: 2001:500:4:12::5\n")
						.append("#      - ripe-ddt.rloc.lisp6.net: 2001:610:240:5:193::170\n\n\n")
